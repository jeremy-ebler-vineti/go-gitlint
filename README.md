[![Release](https://img.shields.io/github/release/llorllale/go-gitlint.svg?style=flat-square)](https://github.com/vinetiworks/go-gitlint/releases/latest)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/vinetiworks/go-gitlint?style=flat-square)](https://goreportcard.com/report/github.com/vinetiworks/go-gitlint)
...
[![Go Doc](https://img.shields.io/badge/godoc-reference-blue.svg?style=flat-square)](http://godoc.org/github.com/vinetiworks/go-gitlint)
...
Usage: ./download-gitlint.sh [-b] bindir [-d] [tag]
  ...
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/vinetiworks/go-gitlint/releases
